...
class TestSequenceGetItem(unittest.TestCase):
    def test(self):
        ...
        self.assertEqual(seq[0:1], sw_compdocs.container.Sequence([1]))
        self.assertEqual(seq[1:2], sw_compdocs.container.Sequence([2]))
        self.assertEqual(seq[2:3], sw_compdocs.container.Sequence([3]))
        self.assertEqual(seq[0:2], sw_compdocs.container.Sequence([1, 2]))
        self.assertEqual(seq[1:3], sw_compdocs.container.Sequence([2, 3]))
        self.assertEqual(seq[0:3], sw_compdocs.container.Sequence([1, 2, 3]))
        self.assertEqual(seq[:2], sw_compdocs.container.Sequence([1, 2]))
        self.assertEqual(seq[1:], sw_compdocs.container.Sequence([2, 3]))
...
class TestMutableSequenceGetItem(unittest.TestCase):
    def test(self):
        ...
        self.assertEqual(seq[1], 2)
        self.assertEqual(seq[2], 3)
        self.assertEqual(seq[0:1], sw_compdocs.container.MutableSequence([1]))
        self.assertEqual(seq[1:2], sw_compdocs.container.MutableSequence([2]))
        self.assertEqual(seq[2:3], sw_compdocs.container.MutableSequence([3]))
        self.assertEqual(seq[0:2], sw_compdocs.container.MutableSequence([1, 2]))
        self.assertEqual(seq[1:3], sw_compdocs.container.MutableSequence([2, 3]))
        self.assertEqual(seq[0:3], sw_compdocs.container.MutableSequence([1, 2, 3]))
        self.assertEqual(seq[:2], sw_compdocs.container.MutableSequence([1, 2]))
        self.assertEqual(seq[1:], sw_compdocs.container.MutableSequence([2, 3]))
